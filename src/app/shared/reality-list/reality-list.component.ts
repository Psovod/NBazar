...
import { RealityCreateFormValues, RealityCreateOptionsSteps } from '../../reality/reality-create/types';
import { realityCreateOptionsSteps } from '../constants/reality-create/real-estate.create-form';
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, NgOptimizedImage, RealityLocationPipe, ImagePathPipe],
